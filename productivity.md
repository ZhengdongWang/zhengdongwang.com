...
{% capture yarkoni %}Tal Yarkoni, [No, it’s not The Incentives—it’s you:](https://talyarkoni.org/blog/2018/10/02/no-its-not-the-incentives-its-you/){% endcapture %}
...
> The first factor is having _clarity_ about _what_ one wants to achieve, _why_ one wants to achieve it, and _how_ to go about achieving it. It’s easy to work hard if you’re clear about these three things, and you’re excited about what you’re doing. Conversely, I think the main cause of aimlessness and procrastination is when you lack clarity on one or more of these points.
